...
public class Companydao {
	...
	public String getsubjectsstringbycid(int cid)
	{
		String s=null;
		
		Examinationdao e=new Examinationdao();
		List< Subjectsbean> list=e.getAllExaminationsubjectsbycid(cid);
		
		for(Subjectsbean sa : list)
		{
			s=s+" , "+sa.getName();
		}
		return s;
	}
	public String getlinksstringbycid(int cid)
	{
		String s=null;
		...
		for(Subjectsbean sa : list)
		{
			List<Materialbean> l=m.getAlllinksbysid(sa.getSid());
			for(Materialbean k : l)
			{
				s=s+" , "+k.getLink();
			}
		}
