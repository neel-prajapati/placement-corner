...
public class Student_electivedao {
	...
	public void deletestudent_elective(String email)
	{
		try
		{
			Connection conn=Projectutil.createConnection();
			String sql="delete from student_elective where  email=?";
			PreparedStatement pst=conn.prepareStatement(sql);
	...
	public List<Electivesbean> getAllelectivessbyemail(String email)
	{
