	...
	<div class="container py-lg-5 py-md-4 py-sm-4 py-3">
		<div class="row mt-lg-5 mt-md-4 mt-3">
			<div class="col-lg-3 col-md-6 col-sm-6 about-abt-grid">
				<a href="https://www.geeksforgeeks.org/array-data-structure"><div class="about-oil-w3layouts text-center">
					
					<div class="about-grid-title">
						<h4 class="mb-lg-3 mb-2">Array</h4>
						
					</div>
				</div></a>	
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6 about-abt-grid">
				<a href="https://www.geeksforgeeks.org/stack-data-structure"><div class="about-oil-w3layouts text-center">
					
					<div class="about-grid-title">
						<h4 class="mb-lg-3 mb-2">Stacks</h4>
						
					</div>
				</div></a>	
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6 about-abt-grid">
				<a href="https://www.geeksforgeeks.org/queue-data-structure"><div class="about-oil-w3layouts text-center">
					
					<div class="about-grid-title">
						<h4 class="mb-lg-3 mb-2">Queues</h4>
						
					</div>
				</div></a>	
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6 about-abt-grid">
				<a href="https://www.geeksforgeeks.org/data-structures/linked-list"><div class="about-oil-w3layouts text-center">
					
					<div class="about-grid-title">
						<h4 class="mb-lg-3 mb-2">Linked-Lists</h4>
		...
		<div class="row mt-lg-5 mt-md-4 mt-3">
			<div class="col-lg-3 col-md-6 col-sm-6 about-abt-grid">
				<a href="https://www.geeksforgeeks.org/binary-tree-data-structure"><div class="about-oil-w3layouts text-center">
					
					<div class="about-grid-title">
						<h4 class="mb-lg-3 mb-2">Binary Tree</h4>
						
					</div>
				</div></a>	
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6 about-abt-grid">
				<a href="https://www.geeksforgeeks.org/binary-search-tree-data-structure"><div class="about-oil-w3layouts text-center">
					
					<div class="about-grid-title">
						<h4 class="mb-lg-3 mb-2">Binary Search Tree</h4>
						
					</div>
				</div></a>	
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6 about-abt-grid">
				<a href="https://www.geeksforgeeks.org/heap-data-structure"><div class="about-oil-w3layouts text-center">
					
					<div class="about-grid-title">
						<h4 class="mb-lg-3 mb-2">Heap</h4>
						
					</div>
				</div></a>	
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6 about-abt-grid">
				<a href="https://www.geeksforgeeks.org/hashing-data-structure"><div class="about-oil-w3layouts text-center">
					
					<div class="about-grid-title">
						<h4 class="mb-lg-3 mb-2">Hashing</h4>
				...
				<div class="row mt-lg-5 mt-md-4 mt-3">
			<div class="col-lg-3 col-md-6 col-sm-6 about-abt-grid">
				<a href="https://www.geeksforgeeks.org/graph-data-structure-and-algorithms"><div class="about-oil-w3layouts text-center">
					
					<div class="about-grid-title">
						<h4 class="mb-lg-3 mb-2">Graph</h4>
						
					</div>
				</div></a>	
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6 about-abt-grid">
				<a href="https://www.geeksforgeeks.org/matrix"><div class="about-oil-w3layouts text-center">
					
					<div class="about-grid-title">
						<h4 class="mb-lg-3 mb-2">Matrix</h4>
						
					</div>
				</div></a>	
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6 about-abt-grid">
				<a href="https://www.geeksforgeeks.org/#Misc"><div class="about-oil-w3layouts text-center">
					
					<div class="about-grid-title">
						<h4 class="mb-lg-3 mb-2">Miscellaneous</h4>
						
					</div>
				</div></a>	
			</div>
			<div class="col-lg-3 col-md-6 col-sm-6 about-abt-grid">
				<a href="https://www.geeksforgeeks.org/advanced-data-structures"><div class="about-oil-w3layouts text-center">
					
					<div class="about-grid-title">
						<h4 class="mb-lg-3 mb-2">Advanced DS</h4>
