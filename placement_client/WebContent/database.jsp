...
<body>
	...
	<div class="container py-lg-5 py-md-4 py-sm-4 py-3" >
		<div class="row mt-lg-5 mt-md-4 mt-3 row-centered">
			<div class="col-lg-3 col-md-6 col-sm-6 about-abt-grid col-centered">
				<a href="https://www.w3schools.com/sql/"><div class="about-oil-w3layouts text-center">
					
					<div class="about-grid-title">
						<h4 class="mb-lg-3 mb-2" >SQL</h4>
