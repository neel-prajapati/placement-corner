...
<script src="js/validation/formvalidationUpdateSubject.js"></script>
</head>
<%
...
<!--header start here-->
	...
	<div class="map"> <!-- ////////////////////// Main Division Starts ///////////////////// -->
		 <h1 style="font-family: 'poppinsbold' ,Arial, sans-serif;font-size: 40px;">Update Subject</h1> 

<!-- <div class="clearfix"> </div>	 -->
<br>
<form action="SubjectController" method="post" id="subject">
<input type="hidden" name="id" value="<%=s.getSid() %>">
  <div class="form-group">
    <label for="subject">Subject Name</label>
    <input type="text" class="form-control" id="subject" name="subject" value="<%=s.getName() %>">
  </div>
