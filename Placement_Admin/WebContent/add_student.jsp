...
<!--header start here-->
	...
	<div class="map"> <!-- ////////////////////// Main Division Starts ///////////////////// -->
		 <h1 style="font-family: 'poppinsbold' ,Arial, sans-serif;font-size: 40px;">Add Student</h1> 
...
<form method="post" action="LoginController" id="student">
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="stud_id" id="stud_id" placeholder="Enter Student ID" required>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="skype" id="skype" placeholder="Enter Skype ID" required>
  </div>
  <div class="form-group">
    <label for="dob">Date Of Birth</label>
    <input type="dob" id="datepicker" name="dob" class="form-control" placeholder="Select Birth Date" required="">
  </div>
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input class="form-control" type="number" name="height" placeholder="Enter Height" required>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input class="form-control" type="text" maxlength="13" minlength="13" name="number" placeholder="Enter Contact Number" id="mobile" required>
  </div>
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input class="form-control" type="number" name="year" placeholder="Enter Batch Year" required>
  </div>
  <div class="form-group">
    <label for="address">Address</label>
    <textarea class="form-control" name="address" id="address" rows="5" placeholder="Enter Address" required> </textarea>
  </div>
  <!-- <div class="form-group">
    <label for=""></label>
  ...
  <button type="submit" class="btn btn-primary" style="float: right;" name="action" value="submit">Submit</button>
