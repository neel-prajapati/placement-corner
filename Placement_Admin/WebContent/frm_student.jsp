...
List<Loginbean> list=dao.getallyears();
List<Degreebean> list1=dao1.getAlldegrees();
...
<!--header start here-->
	...
	<div class="map"> <!-- ////////////////////// Main Division Starts ///////////////////// -->
		 <h1 style="font-family: 'poppinsbold' ,Arial, sans-serif;font-size: 40px;">Student Details</h1> 

<!-- <div class="clearfix"> </div>	 -->
<br>
<form method="post" action="show_student.jsp">
  <div class="form-group">
    ...
    <div>
					...
					<!-- 	<option value="B.Tech(ICT)">BTech</option>
  ...
  <div class="form-group">
    ...
    <div>
					<select class="form-control" name="year" id="year" required>
						...
						<%
						for(Loginbean l:list)
						{
							%>
							<option value="<%=l.getYear()%>"><%=l.getYear()%></option>
