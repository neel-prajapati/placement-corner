...
<!--header start here-->
	...
	<div class="map"> <!-- ////////////////////// Main Division Starts ///////////////////// -->
		 <h1 style="font-family: 'poppinsbold' ,Arial, sans-serif;font-size: 40px;">Add Material</h1> 
...
<div class="form-group">
  ...
  <div class="form-group">
    <label for="material">Material Link</label>
    <input type="url" class="form-control" id="material" name="material" placeholder="Enter Material Link" required>
  </div>
  
  <button type="submit" class="btn btn-primary" style="float: right;" name="action" value="add_material">Submit</button>
