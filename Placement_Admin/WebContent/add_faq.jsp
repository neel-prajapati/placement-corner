...
<!--header start here-->
	...
	<div class="map"> <!-- ////////////////////// Main Division Starts ///////////////////// -->
		 <h1 style="font-family: 'poppinsbold' ,Arial, sans-serif;font-size: 40px;">Add Question-Answer</h1> 
...
<form action="FaqController" method="post">
  <div class="form-group">
    ...
    <textarea class="form-control" id="answer" name="answer" placeholder="Enter Your Answer" required></textarea> 
  </div>
 	<div class="form-group">
  ...
  <button type="submit" class="btn btn-primary" style="float: right;" name="action" value="add_faq">Submit</button>
