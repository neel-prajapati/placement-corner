...
<!--header start here-->
	...
	<div class="map"> <!-- ////////////////////// Main Division Starts ///////////////////// -->
		 <h1 style="font-family: 'poppinsbold' ,Arial, sans-serif;font-size: 40px;">Add Degree</h1> 
...
<form action="DegreeController" method="post" id="degree">
  ...
  <button type="submit" class="btn btn-primary" style="float: right;" name="action" value="add_degree">Submit</button>
