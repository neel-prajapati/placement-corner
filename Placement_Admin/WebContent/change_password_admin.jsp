...
<!--header start here-->
	...
	<div class="map"> <!-- ////////////////////// Main Division Starts ///////////////////// -->
		 <h1 style="font-family: 'poppinsbold' ,Arial, sans-serif;font-size: 40px;">Change Admin Password</h1> 

<!-- <div class="clearfix"> </div>	 -->
<br>
<form id="changepass" action="AdminloginController" method="post">
  <div class="form-group">
    <label for="adminid">Admin ID</label>
    <input type="email" class="form-control" id="adminid" name="id" placeholder="Enter Admin ID" required>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <label for="cnfpassword">Conifrm New Password</label>
    <input type="Password" class="form-control" id="cnfpassword" placeholder="Enter Conifrm Password" required>
  </div>
  <input type="submit" class="btn btn-primary" style="float: right;" name="action" value="Password Change">
  <button type="reset" class="btn btn-primary" style="float: right;margin-right: 10px;">Clear</button> 
</form>
<script>

if(document.getElementById(newpassword)!=document.getElementById(cnfpassword)){
