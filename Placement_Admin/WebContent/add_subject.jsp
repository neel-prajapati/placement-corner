...
<!--header start here-->
	...
	<div class="map"> <!-- ////////////////////// Main Division Starts ///////////////////// -->
		 <h1 style="font-family: 'poppinsbold' ,Arial, sans-serif;font-size: 40px;">Add Subject</h1> 
...
<form action="SubjectController" method="post">
  ...
  <button type="submit" class="btn btn-primary" style="float: right;" name="action" value="add_subject">Submit</button>
