...
<script src="js/validation/formvalidationAdmin.js"></script>
</head> 
...
<!--header start here-->
	...
	<div class="map"> <!-- ////////////////////// Main Division Starts ///////////////////// -->
		 <h1 style="font-family: 'poppinsbold' ,Arial, sans-serif;font-size: 40px;">Add Admin</h1> 
...
<form action="AdminloginController" method="post" id="admin">
  <div class="form-group">
    ...
    <input type="email" class="form-control" name="admin_id" id="admin_id" placeholder="Enter Admin ID" required>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="date" id="datepicker" name="dob" class="form-control" placeholder="Select Birth Date" required="">
  </div>
  <div class="form-group">
  ...
  <button type="submit" class="btn btn-primary" name="action" style="float: right;" value="register_admin">Submit</button>
