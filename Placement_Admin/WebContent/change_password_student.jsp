...
<!--header start here-->
	...
	<div class="map"> <!-- ////////////////////// Main Division Starts ///////////////////// -->
		 <h1 style="font-family: 'poppinsbold' ,Arial, sans-serif;font-size: 40px;">Change Student Password</h1> 

<!-- <div class="clearfix"> </div>	 -->
<br>
<form id="passStud" action="LoginController" method="post">
  ...
  <input type="submit" class="btn btn-primary" style="float: right;" value="Password Change" name="action">
