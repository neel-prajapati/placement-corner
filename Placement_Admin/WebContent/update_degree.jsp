...
<script src="js/validation/formvalidationDegree.js"></script>
</head> 
<%
...
<!--header start here-->
	...
	<div class="map"> <!-- ////////////////////// Main Division Starts ///////////////////// -->
		 <h1 style="font-family: 'poppinsbold' ,Arial, sans-serif;font-size: 40px;">Update Degree</h1> 

<br>
<form action="DegreeController" method="post" id="degree">
	<input type="hidden" value="<%=d.getDid() %>" name="id">
  <div class="form-group">
    <label for="degree">Degree Name</label>
    <input type="text" class="form-control" id="degree" name="degree" value="<%=d.getDname() %>" required>
    <br>
  </div>
